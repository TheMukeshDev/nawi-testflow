  ...
  return `
    ...
    <body>
      ...
      <div class="footer-signatures">
        ...
        <div class="sign-box">
          <div class="role">Authorized Signatory / Reviewer</div>
          <div style="margin-top: 4px; font-weight: bold;">${test.reviewer || 'Dr. K. Sharma'}</div>
          <div style="color: #64748b; font-size: 8pt;">Verification & Approval Authority</div>
        </div>
      </div>

      <div class="seal-tag">
        Verified Digital Report — Generated by NAWI TestFlow (Smart India Hackathon 2026 Problem Statement 26035).
        Valid without physical seal when verified against repository records.
      </div>
    </body>
    </html>
  `;
