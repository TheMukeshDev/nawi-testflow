...
const SYSTEM_SETTINGS: SystemSetting[] = [
  ...
  { key: 'max_upload_size', label: 'Max Upload Size', value: '10 MB', description: 'Maximum file upload size' },
  { key: 'session_timeout', label: 'Session Timeout', value: '8 hours', description: 'User session inactivity timeout' },
  { key: 'report_prefix', label: 'Report Number Prefix', value: 'TR-', description: 'Prefix for auto-generated test report numbers' },
];
